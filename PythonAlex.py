...
def AddNewWindow():
    ...
    btn_addcon = Button(ContactForm, text="Save", width=8, bg="yellow", font=('Lucida Fax', 12), command=SubmitData)
...
btn_add = Button(MidLeftPadding, text="+ ADD NEW", bg="green", font=('Lucida Fax', 12), command=AddNewWindow)
